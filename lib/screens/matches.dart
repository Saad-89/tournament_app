...
import '../main.dart';
import '../widgets/matches/finalRoundMatch.dart';
import '../widgets/matches/seconRoundMatches.dart';
                      ...
                      return FutureBuilder<DocumentSnapshot>(
                        ...
                        builder: (BuildContext context,
                          ...
                          if (tournamentSnapshot.hasError) {
                            return Text('Error: ${tournamentSnapshot.error}');
                          }
                          ...
                          if (!tournamentSnapshot.hasData ||
                              !tournamentSnapshot.data!.exists) {
                            return Text('Tournament not found');
                          }

                          final tournamentData = tournamentSnapshot.data!.data()
                              as Map<String, dynamic>;
                          final tournamentName =
                              tournamentData['name'].toString().toUpperCase();
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => MatchScheduleWidget(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Text('Tap to see your matches in ',
                                              style: TextStyle(
                                                  fontFamily: 'karla',
                                                  color: Colors.white)),
                                          Text('$tournamentName',
...
class MatchScheduleWidget extends StatefulWidget {
  final String tournamentId;
  final String currentUserId;

  MatchScheduleWidget(
      {required this.tournamentId, required this.currentUserId});

  @override
  _MatchScheduleWidgetState createState() => _MatchScheduleWidgetState();
}

class _MatchScheduleWidgetState extends State<MatchScheduleWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Matches',
          style: TextStyle(fontFamily: 'karla', fontSize: 22),
        ),
      ),
                                    ...
                                    return StreamBuilder<DocumentSnapshot>(
                                      ...
                                      builder: (context,
                                        ...
                                        if (team1Snapshot.hasData &&
                                          ...
                                          if (scoreData1 != null &&
                                              ...
                                              (scoreData1['team1Score'] !=
                                                  ...
                                                  scoreData1['team2Score'] !=
                                                      scoreData2[
                                                          'team2Score'])) {
                                            // Scores are different, store the match in the scoredispute collection
                                            FirebaseFirestore.instance
                                          ...
                                          } else if (scoreData1 != null &&
                                              scoreData2 != null &&
                                              scoreData1['team1Score'] ==
                                                  scoreData2['team1Score'] &&
                                              scoreData1['team2Score'] ==
                                                  scoreData2['team2Score']) {
                                            // Scores are the same, proceed to determine the winner and loser
                                            team1Score =
                                                scoreData1['team1Score'];
                                            team2Score =
                                                scoreData1['team2Score'];
...
class EnterReviewPage extends StatefulWidget {
  final String tournamentId;
  final String matchId;
  final String currentUserId;
  final String team1Id;
  ...
  @override
  _EnterReviewPageState createState() => _EnterReviewPageState();
}

class _EnterReviewPageState extends State<EnterReviewPage> {
  final TextEditingController team1ScoreController = TextEditingController();
  final TextEditingController team2ScoreController = TextEditingController();
  int thumbsUpCount = 0;
