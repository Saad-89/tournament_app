...
class SecondRoundMatch extends StatefulWidget {
  final String tournamentId;
  final String currentUserId;

  SecondRoundMatch({required this.tournamentId, required this.currentUserId});

  @override
  _SecondRoundMatchState createState() => _SecondRoundMatchState();
}

class _SecondRoundMatchState extends State<SecondRoundMatch> {
